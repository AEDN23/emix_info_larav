...
@section('title', 'Data Certificate of Analysis')
                                ...
                                <div style="display: flex;">
                                    ...
                                    @if($coa->file)
                                        <button type="button" class="btn-action btn-pdf" title="Lihat PDF"
                                            onclick="showPreview('{{ $coa->nama_coa }}', '{{ $coa->nomer_coa }}', '{{ asset('public/storage/' . $coa->file) }}')">
                                    ...
                                    @if($coa->video && $coa->video !== '-')
                                        <button type="button" class="btn-action btn-video" title="Lihat Video"
                                            onclick="showVideoPreview('{{ $coa->nama_coa }}', '{{ $coa->nomer_coa }}', '{{ asset('public/storage/' . $coa->video) }}')">
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between align-items-center" style="padding: 10px 20px;">
                    <div>
                        <h5 class="mb-0" style="font-size: 14px; font-weight: bold; color: #2E3338;">NAMA COA <span style="margin: 0 10px;">:</span><span id="modalNama"></span></h5>
                        <h5 class="mb-0" style="font-size: 14px; font-weight: bold; color: #2E3338; margin-top: 5px;">NOMOR COA <span style="margin: 0 10px;">:</span><span id="modalNomor"></span></h5>
                    </div>
    ...
    <div class="modal fade" id="videoPreviewModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between align-items-center" style="padding: 10px 20px;">
                    <div>
                        <h5 class="mb-0" style="font-size: 14px; font-weight: bold; color: #2E3338;">NAMA COA <span style="margin: 0 10px;">:</span><span id="modalVideoNama"></span></h5>
                        <h5 class="mb-0" style="font-size: 14px; font-weight: bold; color: #2E3338; margin-top: 5px;">NOMOR COA <span style="margin: 0 10px;">:</span><span id="modalVideoNomor"></span></h5>
                    </div>
                    <button type="button" class="btn text-success fw-bold p-0" data-bs-dismiss="modal" style="font-size: 14px; letter-spacing: 1px;">CLOSE</button>
                </div>
