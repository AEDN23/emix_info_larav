...
@section('title', 'Input Data Certificate of Analysis')
...
@section('content')
    <h1 class="page-title">Input Data Certificate of Analysis (COA)</h1>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td class="form-input-container">
                            <input type="text" name="nomer_coa" value="{{ $nextNo }}" readonly
                    ...
                    <tr>
                        ...
                        <td class="form-input-container">
                            <input type="text" name="nama_coa" value="{{ old('nama_coa') }}" placeholder="Nama Dokumen"
                                required>
                            @error('nama_coa') <span class="error">{{ $message }}</span> @enderror
                        </td>
                    </tr>
                    <tr>
