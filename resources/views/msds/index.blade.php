                                ...
                                <div style="display: flex;">
                                    ...
                                    @if($msds->file)
                                        <button type="button" class="btn-action btn-pdf" title="Lihat PDF"
                                            onclick="showPreview('{{ $msds->nama_msds }}', '{{ $msds->nomer_msds }}', '{{ asset('public/storage/' . $msds->file) }}')">
                                    ...
                                    @if($msds->video && $msds->video !== '-')
                                        <button type="button" class="btn-action btn-video" title="Lihat Video"
                                            onclick="showVideoPreview('{{ $msds->nama_msds }}', '{{ $msds->nomer_msds }}', '{{ asset('public/storage/' . $msds->video) }}')">
