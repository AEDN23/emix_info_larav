...
@section('title', 'Input Data Support Document')
...
@section('content')
    <h1 class="page-title">Input Data Support Document (STD)</h1>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td class="form-input-container">
                            <input type="text" name="nomer_std" value="{{ $nextNo }}" readonly
                    ...
                    <tr>
                        ...
                        <td class="form-input-container">
                            <input type="text" name="nama_std" value="{{ old('nama_std') }}" placeholder="Nama Dokumen"
                                required>
                            @error('nama_std') <span class="error">{{ $message }}</span> @enderror
                        </td>
                    </tr>
                    <tr>
