...
@section('title', 'Input Data Work Instruction')
...
@section('content')
    <h1 class="page-title">Input Data Work Instruction</h1>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('wi.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <table class="form-table">
                    <tr>
                        <td class="form-label">Nomor Dokumen</td>
                        <td class="form-input-container">
                            <input type="text" name="nomer_wi" value="{{ $nextNo }}" readonly
                    ...
                    <tr>
                        ...
                        <td class="form-input-container">
                            <input type="text" name="nama_wi" value="{{ old('nama_wi') }}" placeholder="Nama Dokumen"
                                required>
